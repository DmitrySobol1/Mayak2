...
async function getInfo(){
   ...
   const response  = await fetch(`https://api.directual.com/good/api/v5/data/3_schedule/getCurrentEventSchedule?appID=5481b0b8-ec7f-457d-a582-3de87fb4f347&sessionID=&event_id=${choosedEvent}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json'
        },
